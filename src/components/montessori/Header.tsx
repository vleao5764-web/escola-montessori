...
function CTA({
  ...
  return (
    <a
      ...
      onClick={onClick}
      className={[
        "group relative inline-flex items-center justify-center rounded-[8px] bg-campaign-orange font-display font-extrabold uppercase tracking-[0.01em] text-campaign-deep-purple",
