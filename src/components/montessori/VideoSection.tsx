      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-5 sm:px-8 lg:grid-cols-2 lg:gap-14">
        ...
        <div>
          ...
          <div className="mt-6 space-y-4 text-base leading-relaxed text-white/90 sm:text-lg">
            <p>
              Antes de aprender conteúdos, existe uma base — construída pela
              curiosidade, pela autonomia, pela convivência e pela capacidade de
              descobrir novas possibilidades.
            </p>
            <p>
              Na Escola Montessori, o aluno participa ativamente da construção do
              conhecimento: observa, experimenta, testa, refaz e aprende com cada
              experiência.
            </p>
            <p>
              Com uma metodologia que respeita diferentes ritmos, cada etapa
              prepara o aluno para novos desafios.
            </p>
          </div>

          <p className="mt-6 font-display text-lg font-bold sm:text-xl">
            Escola Montessori.
          </p>
          <img
            src={headlineRoxo}
