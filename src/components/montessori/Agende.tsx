...
import desenho from "@/assets/desenhos/Desenho_15.png";
...
export function Agende() {
  ...
  const inputClass =
    "w-full border-b-2 border-campaign-deep-purple/20 bg-transparent px-1 py-3 text-base text-campaign-deep-purple placeholder:text-campaign-deep-purple/35 focus:border-campaign-blue focus:outline-none";
  ...
  return (
    <section
      ...
      className="relative scroll-mt-24 overflow-hidden bg-campaign-blue py-20 md:py-28"
    >
      <div
        aria-hidden="true"
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute -left-10 bottom-0 w-56 opacity-20 md:w-80"
      />
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:items-center lg:gap-20">
        ...
        <div>
          ...
          <p className="mt-6 max-w-lg text-lg leading-relaxed text-white/85">
            Algumas experiências são difíceis de explicar em palavras. Conheça
            as salas, converse com os educadores e veja a metodologia na
            prática. Agende uma visita e descubra como construímos, todos os
            dias, a base para o futuro do seu filho.
          </p>
        ...
        {/* Formulário */}
        <div className="bg-campaign-surface p-7 shadow-[0_24px_60px_-24px_rgba(10,5,60,0.7)] md:p-10">
          {sent ? (
            <div className="flex min-h-80 flex-col justify-center gap-4">
              ...
              <p className="leading-relaxed text-campaign-deep-purple/80">
                Obrigado, {data.nome.split(" ")[0]}! Nossa equipe entrará em
                contato pelo WhatsApp para confirmar o melhor dia e horário
                para a sua visita.
              </p>
              <button
                type="button"
                ...
                className="mt-2 self-start bg-campaign-deep-purple px-6 py-3 font-display font-bold text-white transition hover:bg-campaign-purple focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-campaign-blue"
              >
